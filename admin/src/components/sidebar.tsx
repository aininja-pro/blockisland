...
import { Home, List, Star, Folder, Megaphone, Calendar, Menu, Settings, BarChart3, Users, MapPinned } from 'lucide-react'
...
const navItems = [
  ...
  { name: 'Scavenger Hunt', href: '/scavenger-hunt', icon: MapPinned },
